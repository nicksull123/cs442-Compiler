...
doIntToFloat(struct ExprRes *Expr)
{
    ...
    AppendSeq(Expr->Instrs,
        GenInstr(NULL, "mtc1", TmpRegName(Expr->Reg), "$f0", NULL));
    AppendSeq(Expr->Instrs, GenInstr(NULL, "cvt.s.w", "$f0", "$f0", NULL));
    AppendSeq(Expr->Instrs,
        GenInstr(NULL, "mfc1", TmpRegName(Expr->Reg), "$f0", NULL));
...
doFloatToInt(struct ExprRes *Expr)
{
    ...
    AppendSeq(Expr->Instrs,
        GenInstr(NULL, "mtc1", TmpRegName(Expr->Reg), "$f0", NULL));
    AppendSeq(Expr->Instrs, GenInstr(NULL, "cvt.w.s", "$f0", "$f0", NULL));
    AppendSeq(Expr->Instrs,
        GenInstr(NULL, "mfc1", TmpRegName(Expr->Reg), "$f0", NULL));
...
doFloatLit(float val)
{
    ...
    AppendSeq(
        res->Instrs, GenInstr(NULL, "mfc1", TmpRegName(res->Reg), "$f0", NULL));
...
doArithFloat(struct ExprRes *Res1, struct ExprRes *Res2, char op)
{
    ...
    AppendSeq(Res1->Instrs,
        GenInstr(NULL, "mtc1", TmpRegName(Res1->Reg), "$f0", NULL));
    AppendSeq(Res1->Instrs,
        GenInstr(NULL, "mtc1", TmpRegName(Res2->Reg), "$f2", NULL));
    AppendSeq(Res1->Instrs, GenInstr(NULL, opc, "$f0", "$f0", "$f2"));
    AppendSeq(
        Res1->Instrs, GenInstr(NULL, "mfc1", TmpRegName(reg), "$f0", NULL));
...
doPrintFloat(struct ExprRes *Expr)
{
    ...
    AppendSeq(
        code, GenInstr(NULL, "mtc1", TmpRegName(Expr->Reg), "$f12", NULL));
...
doCompFloat(struct ExprRes *Res1, struct ExprRes *Res2, int op)
{
    ...
    instrs = GenInstr(NULL, "mtc1", TmpRegName(Res1->Reg), "$f0", NULL);
    AppendSeq(
        instrs, GenInstr(NULL, "mtc1", TmpRegName(Res2->Reg), "$f2", NULL));
    switch (op)
    {
        case B_LT:
